...
mbSet<-ReadSampleTable(mbSet, "P8_WT_F_C.csv");
mbSet<-Read16SAbundData(mbSet, "P8_WT_F_C_genus.csv","text","SILVA","T","false");
...
mbSet<-PlotHeatmap(mbSet, "heatmap_1", "norm", "row","euclidean","ward.D","bwm","Experiment","Genus","overview","F", "png","T","T","13.0","8.8", "3.2","11.9","F");
mbSet<-PlotHeatmap(mbSet, "heatmap_2", "norm", "row","euclidean","ward.D","bwm","Experiment","Genus","detail","F", "png","T","T","13.0","8.8", "3.3","12.0","F");
