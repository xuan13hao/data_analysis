...
# Generate CSV colume
row0=["Index","CHROM","Start","REF","ALT","FORMAT","sample310","sample310001","sample310010","sample3101","sample31010","OmniAffected GT 0/0","OmniAffected GT 0/1","OmniAffected GT 1/1","OmniUnaffected GT 0/0","OmniUnaffected GT 0/1","OmniUnaffected GT 1/1"]
csvfile = file('./FamCsv/Fam310.csv', 'wb')
...
#    print a00,a01,a11,u00,u01,u11
    writer.writerow([i_d,new,pos,ref,alt,forma,ar0,ar1,ar2,ar3,ar4,a00,a01,a11,u00,u01,u11])
